RTK = {}
RTK.timer = 100 -- countdown to secure lock in seconds (time needed to pass to door to be closed back)
RTK.hacktime = 2500 -- first door open delay to make time for police to arrive and roleplay in miliseconds (I highly recommend to leave it be (2.5 min default))
RTK.maxcash = 7500 -- maximum amount of cash a pile can hold
RTK.mincash = 3000 -- minimum amount of cash a pile holds
RTK.black = true -- enable this if you want blackmoney as a reward
RTK.cooldown = 600 -- amount of time to do the heist again in seconds (15min)
RTK.mincops = 0 -- minimum required cops to start mission
RTK.vaultdoor = "v_ilev_gb_vauldr"
RTK.door = "v_ilev_gb_vaubar"
RTK.office = "v_ilev_gb_teldr"
RTK.item1 = "identidade"
RTK.item2 = "identidade"
RTK.Banks = {
    F1 = {
        doors = {
